...
const (
	LineageService_GetLineage_FullMethodName = "/LineageService/GetLineage"
)
...
type LineageServiceClient interface {
	GetLineage(ctx context.Context, in *LineageRequest, opts ...grpc.CallOption) (*LineageResponse, error)
}
...
func (c *lineageServiceClient) GetLineage(ctx context.Context, in *LineageRequest, opts ...grpc.CallOption) (*LineageResponse, error) {
...
type LineageServiceServer interface {
	GetLineage(context.Context, *LineageRequest) (*LineageResponse, error)
...
func (UnimplementedLineageServiceServer) GetLineage(context.Context, *LineageRequest) (*LineageResponse, error) {
...
func _LineageService_GetLineage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LineageServiceServer).GetLineage(ctx, req.(*LineageRequest))
	}
