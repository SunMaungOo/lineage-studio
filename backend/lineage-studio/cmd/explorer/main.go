...
import (
	...
	lse "github.com/SunMaungOo/lineage-studio/internal/lineage-explorer/connect"
	"github.com/rs/cors"
)
...
func main() {
	...
	serverImplementation := LineageExplorerServer{
	...
	path, handler := lse.NewLineageExplorerHandler(
